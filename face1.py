...
# python -m pip install numpy==1.26.4 opencv-contrib-python==4.9.0.80 onnxruntime==1.18.0 tqdm==4.66.4 pillow==10.4.0
...
#   model.onnx
#   labels.json     # ["angry","disgust","fearful","happy","neutral","sad","surprised"] or {"0":"angry",...}
